...
theorem pauli_involution_trace (P₀ : PauliIdx 4) (hP₀ : P₀ ≠ pauliIdentity 4) :
...
/-- Orthogonal support at trace level: Tr(I) - Tr(P₀²) = 0.
    ...
    `witness_fidelity_zero_from_axiom` below (proved from Axiom 2). -/
theorem witness_orthogonal_support (P₀ : PauliIdx 4) (hP₀ : P₀ ≠ pauliIdentity 4) :
...
theorem no_estimator_above_half (P₀ : PauliIdx 4) (hP₀ : P₀ ≠ pauliIdentity 4)
  ...
  ⟨witness_indistinguishable_on_set P₀ S hS_nonid hS_miss,
   witness_trace_correct P₀ hP₀,
   pauli_involution_trace P₀ hP₀,
   witness_orthogonal_support P₀ hP₀⟩
...
theorem fidelity_dichotomy :
  ...
  ⟨fun P₀ hP₀ => ⟨pauli_involution_trace P₀ hP₀, witness_orthogonal_support P₀ hP₀⟩,
...
/-- **CONCLUSION: F(ρ₊, ρ₋) = 0** (Theorem 2(i), orthogonality).
    ...
    NOTE: This conclusion follows directly from the axiom; the non-trivial
    algebraic content (Tr(I) - Tr(P₀²) = 0) is proved in `witness_orthogonal_support`. -/
theorem witness_fidelity_zero_from_axiom (P₀ : PauliIdx 4) (hP₀ : P₀ ≠ pauliIdentity 4) :
